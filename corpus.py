...
FRUITS = ['apple', 'apples', 'banana', 'bananas', 'cherry', 'cherries', 'blueberry', 'blueberries', 'raspberry', 'raspberries', 'berry', 'berries', 'strawberry', 'strawberries', 'pineapple', 'pineapples', 'plums', 'plum', 'grapes', 'lychee', 'passion fruit', 'blackberry','blackberries', 'orange', 'oranges', 'lime', 'limes', 'lemon', 'lemons', 'citrus', 'grapefruit', 'coconut', 'watermelon', 'peach', 'peaches', 'pear', 'pears', 'pumpkin', 'pumpkins', 'currant', 'nectarine', 'gooseberry', 'gooseberries', 'boysenberry', 'huckleberry', 'kiwi', 'fig', 'mango', 'mangoes', 'apricot', 'tangerine', 'clementine', 'date', 'guava', 'papaya', 'persimmon', 'pomegranate', 'melon', 'cantaloupe', 'honeydew', 'dragonfruit', 'starfruit']
VEGETABLES = ['broccoli', 'onion', 'shallot', 'leek', 'fennel', 'green bean', 'bell pepper', 'spinach', 'cabbage', 'asparagus', 'greens', 'pea', 'green pea', 'tomato', 'potato', 'sweet potato', 'carrot', 'celery', 'mushroom', 'cucumber', 'pickles', 'tomatoes', 'vegetable', 'orange bell pepper', 'red bell pepper', 'yellow bell pepper']
